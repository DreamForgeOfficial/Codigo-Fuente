...
<body>
    ...
    <section class="hero">
        <div class="hero-text">
            <h4>Francisco Marchal García</h4>
            <p>
                Soy un apasionado de la informática y siempre estoy encantado de aprender todo lo posible
                sobre esta rama, para poder trabajar y disfrutar personalmente de ello. Con este QR podrás 
                conocerme un poco más a fondo, y visitar mis redes de trabajo en las que estoy más activo. 
                Gracias por tu atención!
            </p>
        </div>

        <div class="hero-img">
            <img src="img/fran.png">
        </div>
